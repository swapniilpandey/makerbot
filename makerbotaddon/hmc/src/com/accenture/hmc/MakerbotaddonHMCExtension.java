...
/**
 * Provides necessary meta information about the makerbotaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.2
 */
public class MakerbotaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MakerbotaddonHMCExtension.class.getName());
