...
/**
 * This is the extension manager of the Makerbotaddon extension.
 */
public class MakerbotaddonManager extends GeneratedMakerbotaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MakerbotaddonManager.class.getName());
	 ...
	 */
	public static MakerbotaddonManager getInstance()
	{
		return (MakerbotaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MakerbotaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MakerbotaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MakerbotaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MakerbotaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MakerbotaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
